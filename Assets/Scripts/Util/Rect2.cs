...
{
    /// <summary>
    /// A 2D integer rectangle class. Unlike UnityEngine.Rect, this one is designed to work seamlessly with Unity's 2D
    /// view, where the Rect starts in the lower-left corner and Y grows as you go up the screen. It also works well
    /// placed in 3D space in the X-Z plane. where Y = Z.
    /// </summary>
    /// [Serializable]
    public struct Rect2 : IEquatable<Rect2>, IEnumerable<Vec2>
    {
        /// <summary>
        ...
        public static Rect2 Row(int size)
        {
            return new Rect2(0, 0, size, 1);
        }
        ...
        /// <param name="size">The width of the rectangle.</param>
        /// <returns>The new rectangle.</returns>
        public static Rect2 Row(int x, int y, int size)
        {
            return new Rect2(x, y, size, 1);
        }
        ...
        /// <param name="size">The width of the rectangle.</param>
        /// <returns>The new rectangle.</returns>
        public static Rect2 Row(Vec2 position, int size)
        {
            return new Rect2(position.x, position.y, size, 1);
        }
        ...
        /// <returns>The new rectangle</returns>
        public static Rect2 Column(int size)
        {
            return new Rect2(0, 0, 1, size);
        }
        ...
        /// <param name="size">The height of the rectangle.</param>
        /// <returns>The new rectangle.</returns>
        public static Rect2 Column(int x, int y, int size)
        {
            return new Rect2(x, y, 1, size);
        }
        ...
        /// <param name="size">The height of the rectangle.</param>
        /// <returns>The new rectangle.</returns>
        public static Rect2 Column(Vec2 position, int size)
        {
            return new Rect2(position.x, position.y, 1, size);
        }
        ...
        public static Rect2 CenterIn(Rect2 toCenter, Rect2 main)
        {
            Vec2 position = main.Position + ((main.Size - toCenter.Size) / 2);
            
            return new Rect2(position, toCenter.Size);
        }
        
        #region Operators

        public static bool operator ==(Rect2 r1, Rect2 r2)
        {
            return r1.Equals(r2);
        }
        ...
        public static Rect2 operator +(Rect2 r1, Vec2 v2)
        {
            return new Rect2(r1.Position + v2, r1.Size);
        }

        public static Rect2 operator +(Vec2 v1, Rect2 r2)
        {
            return new Rect2(r2.Position + v1, r2.Size);
        }
        ...
        public Rect2(Vec2 size) : this(Vec2.Zero, size) { }
        
        public Rect2(int x, int y, int width, int height) : this(new Vec2(x, y), new Vec2(width, height)) { }

        public Rect2(Vec2 position, int width, int height) : this(position, new Vec2(width, height)) { }
        
        public Rect2(int width, int height) : this(new Vec2(width, height)) { }
        
        public Rect2(int x, int y, Vec2 size) : this(new Vec2(x, y), size) { }
        ...
        public Rect2 Offset(Vec2 position, Vec2 size)
        {
            return new Rect2(_position + position, _size + size);
        }

        public Rect2 Offset(int x, int y, int width, int height)
        {
            return Offset(new Vec2(x, y), new Vec2(width, height));
        }
        
        public Rect2 Inflate(int distance)
        {
            return new Rect2(_position.Offset(-distance, -distance), _size.Offset(distance * 2, distance * 2));
        }
        ...
        public bool Overlaps(Rect2 rect)
        {
        ...
        public Rect2 CenterIn(Rect2 rect)
        {
        ...
        public IEnumerable<Vec2> Trace()
        {
            ...
            {
                // a single row
                foreach (Vec2 position in Row(BottomLeft, Width)) yield return position;
            }
            else if ((Width == 1) && (Height >= 1))
            {
                // a single column or one unit
                foreach (Vec2 position in Column(BottomLeft, Height)) yield return position;
            }
        ...
        {
            if (obj is Rect2) return Equals((Rect2)obj);
